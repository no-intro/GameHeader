namespace GameHeader.Systems
{
    ...
    public class GBCProcessor : Processor
    {
        private byte[] __data;
        ...
        public GBCProcessor() : base(SystemType.GBC)
        {
            this.__logocrc16 = new CRC16();
            base._extensions = base._config.GetValue("AUTODETECT_EXTENSIONS", "GBC").Split(new string[] { "," }, StringSplitOptions.RemoveEmptyEntries);
        }
        ...
        {
            base._game = new GBCGame(game_info);
        ...
        {
            GBCGame game = (GBCGame) base.Finalize();
