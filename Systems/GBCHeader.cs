namespace GameHeader.Systems
{
    ...
    public struct GBCHeader
    {
        ...
        public string Title
        {
            get
            {
                return Util.SJIS(this.__header, 0x34, 11);
            }
        }
        ...
        public string ExtendedTitle
        {
            get
            {
                return Util.SJIS(this.__header, 0x34, 15);
            }
        }
        ...
        public string Serial
        {
            get
            {
                return Util.ASCII(this.__header, 0x3f, 4);
            }
        }

        public string GBCFlag
        {
            get
            {
                return Util.Hex(this.__header, 0x43, 1);
            }
        }
